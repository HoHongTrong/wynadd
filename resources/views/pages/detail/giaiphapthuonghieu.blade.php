...
@section('content')
  ...
  <div class="parallax-window" data-parallax="scroll" data-image-src="img/1920x1080/01.jpg">
    <div class="parallax-content container">
      ...
      <h1 style="color: white">Giải pháp thương hiệu</h1>
    </div>
  </div>
    ...
    <div class="row" id="customaa" >
      <div class="col-sm-7 sm-margin-b-50" >
        <div class="margin-b-30" >
          <p style="color: #111111">- Một thiết kế logo chuyên nghiệp, một tên thương hiệu dễ nhớ ấn tượng,
            một slogan nói đúng giá trị mà thương hiệu muốn đưa đến khách hàng thì cũng mới chỉ là những bước đầu tiên của việc xây dựng một thương hiệu.<br><br>

            - Để giúp cho gia tăng sự nhận biết về thương hiệu của mình trên thị trường bạn cần phải có một chuyên gia tư vấn,
            <b>một công ty thiết kế chuyên nghiệp </b>để sẳn sàng cùng bạn tìm hiểu, khảo sát và lên kế hoạch một lộ trình chi tiết và hiệu quả.<br><br>

            - Đó là điều công ty chúng tôi hiểu được và phải cung cấp các dịch vụ không chỉ là thiết kế logo,
            thiết kế nhận diện thương hiệu, mà chúng tôi còn thiết kế và xây dựng cả một chiến lược để giúp thương hiệu của bạn phát triển.</p>
        </div >
      </div>
      <div class="col-sm-4 col-sm-offset-1">
        <img class="img-responsive" src="img/logonho.jpg" alt="Our Office">
      </div>
      <img src="img/640x380/giai-phap-thuong-hieu-wynads-768x466.jpg">
      <br>
      <br>
      ===================================================================================================
